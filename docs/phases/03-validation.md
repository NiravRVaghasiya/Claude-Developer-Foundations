# Phase 03 — Content Quality Gates

## Execution prompt

```text
Implement strict schema validation for blueprint, sources, topics, flashcards, questions, and exam data. Add npm run validate:content and tests for invalid IDs, missing explanations, duplicate records, orphan content, and invalid metadata. Make CI-ready.
