# Phase 02 — Curriculum Upgrade

## Execution prompt

```text
Upgrade curriculum quality using the blueprint. For each skill ensure learning objectives, concepts, practical examples, trade-offs, common mistakes, scenarios, exam-oriented reasoning, and authoritative sources. Add difficulty and cognitive-level metadata. Flag uncertain claims instead of guessing.
