# Phase 10 — Final 10/10 Audit

## Execution prompt

```text
Act as an adversarial senior engineer, curriculum reviewer, learning-science reviewer, accessibility specialist, QA engineer, and release manager. Score the entire platform. For every area below 9/10 identify evidence and implement only high-impact fixes. Produce docs/FINAL_AUDIT.md and a SHIP/FIX/BLOCK verdict.
