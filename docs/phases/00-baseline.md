...
```text
Perform a complete repository audit before feature work. Run install, tests, lint/typecheck where available, and production build. Inspect architecture, content, SRS, quiz, search, persistence, and tests. Create baseline documentation and metrics. Fix only clear existing build/test issues. Do not redesign working architecture.
