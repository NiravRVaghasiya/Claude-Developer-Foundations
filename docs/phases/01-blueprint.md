# Phase 01 — Blueprint and Provenance

## Execution prompt

```text
Create a structured CCDV-F blueprint and source/provenance model. Map topics, flashcards, and quiz questions to stable skills. Add validation for broken mappings and missing evidence. Treat the official exam guide and authoritative documentation as the source of truth. Never invent requirements.
