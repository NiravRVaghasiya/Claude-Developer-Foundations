...
```text
Build an explainable skill-mastery and recommendation engine using quiz results, SRS state, recency, accuracy, difficulty, confidence, and exposure. Add a daily study plan that prioritizes weak and overdue skills. Preserve existing SRS behavior unless change is justified.
