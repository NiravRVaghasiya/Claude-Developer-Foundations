# Phase 07 — UX and Accessibility

## Execution prompt

```text
Upgrade dashboard, topic pages, flashcards, quizzes, diagnostic results, search, and exam UI. Target WCAG 2.2 AA. Ensure keyboard navigation, focus, semantics, mobile usability, readable states, and reduced motion support.
